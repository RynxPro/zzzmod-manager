            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-medium text-moon-text/80">
                    Included Mods
                  </label>
                    ...
                    filteredMods.map((mod) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-moon-text truncate">
                            {mod.name}
                          </p>
                          <p className="text-xs text-moon-text/50 truncate">
                            {mod.id}
                          </p>
                        </div>
                        <div
                ...
                <p className="mt-1 text-xs text-moon-text/50">
                  {selectedMods.size} mod{selectedMods.size !== 1 ? "s" : ""}{" "}
                  selected
                </p>
              </div>
            </div>
