      ...
      <div className="relative max-w-md mx-auto mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-4 py-2.5 rounded-lg bg-moon-surface/50 text-moon-text placeholder-moon-muted/70 border border-white/10 focus:outline-none focus:ring-2 focus:ring-moon-accent/50 focus:border-transparent shadow-sm hover:shadow-moonGlowCyan/30 transition-all duration-200 backdrop-blur-sm"
