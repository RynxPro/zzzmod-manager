    ...
    >
      <div className="relative mb-4 group-hover:scale-105 transition-transform duration-300">
        ...
        <img
          src={imageUrl}
          alt={name}
          className="relative z-10 w-24 h-24 rounded-full object-cover shadow-md group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-300 rotate-180"
        />
      </div>
      <div className="relative">
        <h3 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-gaming-text-primary to-gaming-text-primary mb-1 text-center tracking-wide group-hover:from-gaming-accent-blue group-hover:to-gaming-accent-violet transition-all duration-300">
          {name}
        </h3>
      </div>
