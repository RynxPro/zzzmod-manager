...
const AboutPage: React.FC = () => {
  return (
    <div className="p-8 space-y-6">
      ...
      >
        <motion.div
          className="w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-gaming-accent-cyan to-gaming-accent-violet p-6 shadow-glow"
        ...
        <p className="text-gaming-text-secondary text-lg max-w-md mx-auto">
